...
that store **records** - see the table near the end of this section for an example.
...
Relationships between records in different tables should be
...
At this stage you need only print out the records to the screen (in the following section you will store this data in memory in a suitable data structure).
